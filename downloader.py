...
parser.add_argument('-number_of_classes', default = 20, type=int)
parser.add_argument('-images_per_class', default = 100, type=int)
parser.add_argument('-data_root', default=r'C:\Users\dschm\PycharmProjects\ba_thesis\data\ImageNet' , type=str)
...
parser.add_argument('-multiprocessing_workers', default = 4, type=int)
...
def get_image(img_url_path):
    ...
    #time.sleep(3)
    img_url, class_folder = img_url_path
...
def print_stats(cls, print_func=print()):
...
if __name__ == '__main__':
    ...
    for class_wnid in classes_to_scrape:
        ...
        urls = [(url.decode('utf-8'), class_folder) for url in resp.content.splitlines()]
